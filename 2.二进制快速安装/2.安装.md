...
## 1.下载 Kafka Eagle
  * [下载地址](https://coding.net/u/smartloli/p/kafka-eagle-bin/git/raw/master/kafka-eagle-1.0.1-bin.tar.gz)

## 2.解压 Kafka Eagle
这里我们解压到 ``` /data/soft/new ``` 目录下，解压命令，如下所示：
```bash
tar -zxvf kafka-eagle-1.0.1-bin.tar.gz
```
...
export KE_HOME=/data/soft/new/kafka-eagle-1.0.1
