# [Release V1.2.0] 2018-01-23
  [Release] Add：Release [Kafka Eagle V1.2.0](https://coding.net/u/smartloli/p/kafka-eagle-bin/git/archive/v1.2.0.tar.gz) version,The following changes:
  1. Open universal permission authentication.
  2. Optimize ```ke.sh``` script.
